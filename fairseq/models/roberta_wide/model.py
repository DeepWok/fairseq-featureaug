...
@register_model("roberta_wide")
class RobertaWideModel(FairseqEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
...
@register_model_architecture("roberta_wide", "roberta_wide")
...
@register_model_architecture("roberta_wide", "roberta_prenorm_wide")
...
@register_model_architecture("roberta_wide", "roberta_base_wide")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("roberta_wide", "roberta_large_wide")
...
@register_model_architecture("roberta_wide", "xlm_wide")

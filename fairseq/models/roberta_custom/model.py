...
@register_model("roberta_faug")
class RobertaModelFaug(FairseqEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
...
@register_model_architecture("roberta_faug", "roberta_faug")
...
@register_model_architecture("roberta_faug", "roberta_prenorm_faug")
...
@register_model_architecture("roberta_faug", "roberta_base_faug")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("roberta_faug", "roberta_large_faug")
...
@register_model_architecture("roberta_faug", "xlm_faug")
